...
System.out.println("Did concatArray(test,test2) combine both: " + (arrayToString(concatArray(test, test2)).equals(arrayToString(test).substring(0,test.length-1)+ ", " + arrayToString(test2).substring(1))));
  }
